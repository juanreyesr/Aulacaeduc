  ...
  return (
    <div className="flex flex-col items-center gap-6">
      ...
      <div className="overflow-auto w-full flex justify-center p-4">
        <div 
          ref={certRef}
          className="bg-white text-black w-[1100px] h-[750px] p-2 relative shadow-2xl"
          style={{ fontFamily: "'Times New Roman', Georgia, serif" }}
        >
          {/* Borde Decorativo */}
          <div className="w-full h-full border-[10px] border-double border-[#003366] p-10 flex flex-col items-center justify-between text-center relative bg-[#fffef5]">
            ...
            <div className="w-full flex justify-center items-end mt-12 mb-8">
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-xs text-gray-500">Evaluación Aprobada: {currentDate.toLocaleDateString('es-GT')}</span>
              </div>
            </div>
